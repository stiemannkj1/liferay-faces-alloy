...
public class InputDateTimeMobileBrowserTester extends TesterBase {
	...
	public void setUpBrowserDriverSimulatingMobile() {
		...
		if (browserDriverSimulatingMobile == null) {
			...
			if (browserName == null && (browserHeadlessString == null || "true".equals(browserHeadlessString))) {

				browserName = "phantomjs";
				browserHeadlessString = "true";
			}
			else if (("chrome".equals(browserName) || "firefox".equals(browserName)) && browserHeadlessString == null) {
				browserHeadlessString = "false";
			}
			else if ("chrome".equals(browserName) && "true".equals(browserHeadlessString)) {

				logger.warn("Chrome does not support simulating a mobile browser in headless mode. Running tests in PhantomJS instead.");
				browserName = "phantomjs";
			}
